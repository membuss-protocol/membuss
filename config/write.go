...
//
// The networking list fields are appended
...
# Additional public addresses to advertise alongside observed, NAT-mapped,
# and interface addresses. Usually empty unless the node has a known DNS name.
announce_addrs:
<<ANNOUNCE_ADDRS>>
...
# Dedicated Circuit Relay v2 peers. Bootstrap nodes do not need to be relays;
# dynamic relay providers discovered through the DHT supplement this list.
relay_peers:
<<RELAY_PEERS>>
...
# Enable libp2p mDNS discovery only for trusted LAN/private-cluster discovery.
# Public deployments should leave this false.
...
func writeTemplate(cfg *Config) (string, error) {
	...
	r := strings.NewReplacer(
		...
		"<<ANNOUNCE_ADDRS>>",               announceBlock,
		"<<BOOTSTRAP_PEERS>>",              bootBlock,
		"<<RELAY_PEERS>>",                  relayBlock,
	)
