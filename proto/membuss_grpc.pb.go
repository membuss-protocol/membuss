...
func (UnimplementedMembussNodeServer) AddDirStream(*AddRequest, grpc.ServerStreamingServer[AddProgress]) error {
	return status.Errorf(codes.Unimplemented, "method AddDirStream not implemented")
}
...
func (UnimplementedMembussNodeServer) DHTPeek(context.Context, *DHTPeekRequest) (*DHTPeekResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DHTPeek not implemented")
}
...
func (UnimplementedMembussNodeServer) AnchorStatus(context.Context, *AnchorStatusRequest) (*AnchorStatusResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AnchorStatus not implemented")
}
...
func RegisterMembussNodeServer(s grpc.ServiceRegistrar, srv MembussNodeServer) {
	// If the following call pancis, it indicates UnimplementedMembussNodeServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
